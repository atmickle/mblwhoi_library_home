...
#announcements-box .item-list {
    height: 134px;
    margin-right: auto;
    margin-left: auto;
}

#announcements-box .item-list ul {
    margin: 0; padding: 0;
    list-style: none;
    display: block;
    overflow: hidden;
...
#announcements-box .item-list li {
    width: 355px;
...
#announcements-box .item-list li .announcement-icon{
  background-image: url('/sites/all/themes/wonderwheel/img/authorpub-coverbg.png');
  margin-right: 2px;
...
<!-- end announcements -->
	    ...
	    <div id="main" class="strip">
	      ...
	      <div id="content" class="page">
	        ...
	        <?php if ($content_top): ?>
	          <div id="content-top" class="hp-section">
	            <?php print $content_top; ?>
	          </div> <!-- /#content-top -->
	        <?php endif; ?>
	
	        <?php if ($breadcrumb or $tabs or $help or $messages): ?>
	          <div id="content-header" class="hp-section">
	        ...
	        <div id="content-area" class="hp-section">
	          
	          <?php print $content; ?>
	        </div>
	
	        <?php if ($content_bottom): ?>
	          <div id="content-bottom" class="hp-section">
