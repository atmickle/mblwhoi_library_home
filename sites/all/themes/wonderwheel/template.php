 ...
 *   entirety and paste it here, changing the prefix from theme_ to wonderwheel_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: wonderwheel_breadcrumb()
 *
 *   where wonderwheel is the name of your sub-theme. For example, the
...
if (theme_get_setting('wonderwheel_fixed')) {
 ...
 */
function wonderwheel_theme(&$existing, $type, $theme, $path) {
...
function wonderwheel_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function wonderwheel_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function wonderwheel_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function wonderwheel_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
